...
public class RangeIndexProviderFactory extends AbstractIndexProviderFactory<RangeIndexProvider> {
    @Override
    ...
    @Override
    protected RangeIndexProvider internalCreate(
            PageCache pageCache,
    ...
    @VisibleForTesting
    public static RangeIndexProvider create(
            PageCache pageCache,
            Path storeDir,
            FileSystemAbstraction fs,
            Monitors monitors,
