...
public class SharedWebContainerTestBase {
    ...
    public static void allocateServer() throws Throwable {
        ...
        suppressAll().call((Callable<Void>) () -> {
            ...
            setWebContainerBuilderProperty(ServerSettings.http_x_forward_enabled.name(), TRUE);
            setWebContainerBuilderProperty(
                    ServerSettings.http_x_forward_allow_hosts.name(), "dummy.example.org, foobar.com");
