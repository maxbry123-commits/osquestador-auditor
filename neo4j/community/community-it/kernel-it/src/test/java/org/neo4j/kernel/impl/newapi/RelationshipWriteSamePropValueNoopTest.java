...
public class RelationshipWriteSamePropValueNoopTest extends RelationshipWriteTestBase<WriteTestSupport> {
    @Override
    ...
    @Override
    void relationshipApplyChangesShouldWriteIfPropertyIsSameValue() {}

    @Test
    void relationshipApplyChangesShouldNotWriteIfPropertyIsSameValue() throws Exception {
        // Given
        String propertyKey = "key";
        Value theValue = stringValue("The Value");
        long relationshipId = createRelationshipWithProperty(TYPE, propertyKey, theValue.asObject());
