...
public class UserAggregationFunctionVisitorTest {
    ...
    public void aggregation_functions_with_specified_name_cannot_be_in_root_namespace() {
        Element function =
                elementTestUtils.findMethodElement(UserAggregationFunctionsExamples.class, "functionWithName");
    ...
    public void aggregation_functions_with_specified_value_cannot_be_in_root_namespace() {
        Element function =
                elementTestUtils.findMethodElement(UserAggregationFunctionsExamples.class, "functionWithValue");
    ...
    public void aggregation_functions_with_unsupported_return_types_are_invalid() {
        Element function =
                elementTestUtils.findMethodElement(UserAggregationFunctionsExamples.class, "wrongReturnType");
        ...
        assertThat(errors)
                ...
                .extracting(
                        ...
                        CompilationMessage::getContents)
                .contains(tuple(
                        Diagnostic.Kind.ERROR, function, "Unsupported return type <void> of aggregation function."));
    }

    @Test
    public void aggregation_functions_with_parameters_are_invalid() {
        Element function =
                elementTestUtils.findMethodElement(UserAggregationFunctionsExamples.class, "shouldNotHaveParameters");
    ...
    public void aggregation_update_functions_with_unsupported_parameter_types_are_invalid() {
        Element function = elementTestUtils.findMethodElement(
                UserAggregationFunctionsExamples.class, "updateWithWrongParameterType");
    ...
    public void aggregation_functions_with_non_annotated_parameters_are_invalid() {
        Element function = elementTestUtils.findMethodElement(
                UserAggregationFunctionsExamples.class, "missingParameterAnnotation");
        ...
        assertThat(errors)
                ...
                .extracting(CompilationMessage::getCategory, CompilationMessage::getContents)
                .contains(tuple(
                        Diagnostic.Kind.ERROR, "@org.neo4j.procedure.Name usage error: missing on parameter <foo>"));
    }
