...
public final class HelloMessageDecoderV53 extends DefaultHelloMessageDecoder {
    private static final HelloMessageDecoderV53 INSTANCE = new HelloMessageDecoderV53();

    private HelloMessageDecoderV53() {}

    public static HelloMessageDecoderV53 getInstance() {
        return INSTANCE;
    }
