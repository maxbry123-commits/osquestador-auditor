 ...
 */
case object RemoveUnusedVariables extends Phase[PlannerContext, LogicalPlanState, LogicalPlanState]
  ...
  override def process(from: LogicalPlanState, context: PlannerContext): LogicalPlanState = {
    from.withMaybeLogicalPlan(Some(from.logicalPlan.endoRewrite(RemoveUnusedVariablesRewriter)))
  }
}
