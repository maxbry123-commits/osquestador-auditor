...
class VectorSSFAllTest extends VectorSSFTestBase {
    ...
    void singleInteger() throws Exception {
        ...
        assertThat(queryNodeIndex(allQuery("age")))
    ...
    void singleString() throws Exception {
        ...
        assertThat(queryNodeIndex(allQuery("name")))
                .extracting(EXTRACT_ID)
                .containsExactlyInAnyOrder(10L, 20L, 30L, 40L, 50L);
    }
    ...
    void stringAndInteger() throws Exception {
        ...
        assertThat(queryNodeIndex(allQuery("name"), allQuery("age")))
                .extracting(EXTRACT_ID)
                .containsExactlyInAnyOrder(10L, 20L, 30L, 40L, 50L);
        ...
        assertThat(queryNodeIndex(rangeQuery("name", Values.of("B"), true, Values.of("C"), true), allQuery("age")))
                .extracting(EXTRACT_ID)
    ...
    void nonIndexableType() throws Exception {
        ...
        assertThat(queryNodeIndex(allQuery("location")))
                .extracting(EXTRACT_ID)
                .containsExactlyInAnyOrder(10L, 20L, 30L, 40L, 50L);
    }
}
