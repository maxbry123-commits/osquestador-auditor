...
public class ValueComparisonTest {
    ...
    private final Object[] objs = new Object[] {
        ...
        new ZonedDateTime[] {
            datetime(2018, 2, 2, 0, 0, 0, 0, "+00:00").asObjectCopy(),
            datetime(1991, 2, 2, 1, 30, 0, 0, "+00:00").asObjectCopy()
        },
        new ZonedDateTime[] {
            datetime(2018, 2, 2, 0, 0, 0, 0, "+00:00").asObjectCopy(),
            datetime(1992, 2, 2, 1, 30, 0, 0, "+00:00").asObjectCopy()
        },
        new ZonedDateTime[] {
            datetime(2019, 2, 2, 0, 0, 0, 0, "+00:00").asObjectCopy(),
            datetime(1991, 2, 2, 1, 30, 0, 0, "+00:00").asObjectCopy()
        },
        new LocalDateTime[] {},
        new LocalDateTime[] {
            localDateTime(2019, 2, 2, 0, 0, 0, 0).asObjectCopy(),
            localDateTime(1991, 2, 2, 1, 30, 0, 0).asObjectCopy()
        },
        ...
        new OffsetTime[] {
            time(0, 0, 1, 0, "+00:00").asObjectCopy(),
            time(0, 0, 1, 0, "+00:00").asObjectCopy()
        },
        new LocalTime[] {localTime(0, 0, 0, 1).asObjectCopy()},
        new LocalTime[] {localTime(0, 0, 1, 0).asObjectCopy()},
        new LocalTime[] {
            localTime(0, 0, 1, 0).asObjectCopy(), localTime(0, 0, 1, 0).asObjectCopy()
        },
        ...
        datetime(
                ...
                0,
                0,
                "Europe/Berlin"), // same offset as +01:00, but name zones come after offsets ...
