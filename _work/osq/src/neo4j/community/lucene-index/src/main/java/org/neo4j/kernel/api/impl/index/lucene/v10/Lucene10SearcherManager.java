...
class Lucene10SearcherManager implements LuceneSearcherManager {
    final SearcherManager searcherManager;

    Lucene10SearcherManager(SearcherManager searcherManager) {
        this.searcherManager = searcherManager;
    }

    @Override
    public LuceneIndexSearcher acquire() throws IOException {
        return new Lucene10IndexSearcher(this);
    }
