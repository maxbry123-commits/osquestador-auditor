...
class GenerateListenerMavenPlugin extends AbstractMojo {
  ...
  override def execute(): Unit = {
    ...
    val abstractParseListenerBuilderSpec = TypeSpec.classBuilder(listenerName)
      ...
      .addField(TypeName.BOOLEAN, "jsSemanticAnalysis", Modifier.PRIVATE, Modifier.FINAL)
      .addMethod(genListenerConstructor())
  ...
  private def genListenerConstructor() = {
    MethodSpec
      .constructorBuilder()
      .addModifiers(Modifier.PUBLIC)
      .addParameter(TypeName.BOOLEAN, "jsSemanticAnalysis")
      .addCode(
        s"""
