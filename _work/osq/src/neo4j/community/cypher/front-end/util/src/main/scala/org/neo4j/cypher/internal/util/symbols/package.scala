...
package object symbols {
  ...
  val CTInteger16: Integer16Type = Integer16Type(isNullable = true)(InputPosition.NONE)
  val CTInteger8: Integer8Type = Integer8Type(isNullable = true)(InputPosition.NONE)
  val CTVector: VectorType = VectorType(None, None, isNullable = true)(InputPosition.NONE)
