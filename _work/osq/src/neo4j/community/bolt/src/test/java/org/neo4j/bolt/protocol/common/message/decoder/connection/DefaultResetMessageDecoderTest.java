...
public class DefaultResetMessageDecoderTest
        implements SingletonMessageDecoderTest<DefaultResetMessageDecoder, ResetMessage> {

    @Override
    public DefaultResetMessageDecoder getDecoder() {
