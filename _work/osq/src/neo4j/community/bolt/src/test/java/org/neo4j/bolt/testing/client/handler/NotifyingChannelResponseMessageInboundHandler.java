...
public class NotifyingChannelResponseMessageInboundHandler extends SimpleChannelInboundHandler<ResponseMessage> {
    private final List<ResponseMessage> responseMessages;
    private final Object lock;

    public NotifyingChannelResponseMessageInboundHandler(List<ResponseMessage> responseMessages, Object lock) {
