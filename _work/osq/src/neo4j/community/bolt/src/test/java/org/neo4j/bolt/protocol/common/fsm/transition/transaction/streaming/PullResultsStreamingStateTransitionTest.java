...
class PullResultsStreamingStateTransitionTest
        extends AbstractStreamingStateTransitionTest<PullMessage, PullResultsStreamingStateTransition> {

    @Override
    protected PullResultsStreamingStateTransition getTransition() {
