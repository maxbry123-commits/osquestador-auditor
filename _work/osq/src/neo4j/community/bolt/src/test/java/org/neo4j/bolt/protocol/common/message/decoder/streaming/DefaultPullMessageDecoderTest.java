...
public class DefaultPullMessageDecoderTest
        implements StreamingMessageDecoderTest<DefaultPullMessageDecoder, PullMessage> {

    @Override
    public DefaultPullMessageDecoder getDecoder() {
