...
public final class FailureMessageEncoderV40 implements StructWriter<Connection, FailureMessage> {
    private static final FailureMessageEncoderV40 INSTANCE = new FailureMessageEncoderV40();

    private FailureMessageEncoderV40() {}

    public static FailureMessageEncoderV40 getInstance() {
        return INSTANCE;
    }
