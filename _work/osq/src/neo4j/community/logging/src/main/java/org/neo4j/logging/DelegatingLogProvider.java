...
public class DelegatingLogProvider implements InternalLogProvider {
    private final InternalLogProvider delegate;

    public DelegatingLogProvider(InternalLogProvider delegate) {
