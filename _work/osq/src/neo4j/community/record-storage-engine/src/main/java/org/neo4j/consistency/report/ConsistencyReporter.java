...
public class ConsistencyReporter implements ConsistencyReport.Reporter {
    ...
    private static final ProxyFactory<RelationshipConsistencyReport> RELATIONSHIP_REPORT =
            create(RelationshipConsistencyReport.class);
    private static final ProxyFactory<PropertyConsistencyReport> PROPERTY_REPORT =
            create(PropertyConsistencyReport.class);
    private static final ProxyFactory<RelationshipTypeConsistencyReport> RELATIONSHIP_TYPE_REPORT =
            create(RelationshipTypeConsistencyReport.class);
    private static final ProxyFactory<LabelTokenConsistencyReport> LABEL_KEY_REPORT =
            create(LabelTokenConsistencyReport.class);
    ...
    private static final ProxyFactory<RelationshipGroupConsistencyReport> RELATIONSHIP_GROUP_REPORT =
            create(RelationshipGroupConsistencyReport.class);
    ...
    public abstract static class ReportInvocationHandler<REPORT extends ConsistencyReport>
    ...
    private <RECORD extends AbstractBaseRecord, REPORT extends ConsistencyReport> REPORT report(
            ProxyFactory<REPORT> factory, RecordType type, RECORD record) {
