...
public interface ConsistencyReport {
    ...
    interface PrimitiveConsistencyReport extends ConsistencyReport {
        ...
        @Documented("The property chain contains a property whose value violates a type constraint.")
        void typeConstraintViolation(int key);
    ...
    interface RelationshipConsistencyReport extends PrimitiveConsistencyReport {
    ...
    interface RelationshipInUseWithCorrectRelationshipTypeReport extends ConsistencyReport {
        ...
        void relationshipDoesNotHaveExpectedRelationshipType(
                RelationshipRecord referredRelationshipRecord, long expectedRelationshipTypeId);
    ...
    interface RelationshipTypeScanConsistencyReport extends RelationshipInUseWithCorrectRelationshipTypeReport {
        ...
        @Override
        @Documented(
                "This relationship type scan document refers to a relationship that does not have the expected type.")
        void relationshipDoesNotHaveExpectedRelationshipType(
                RelationshipRecord referredRelationshipRecord, long expectedRelationshipTypeId);
    ...
    interface IndexConsistencyReport
            extends NodeInUseWithCorrectLabelsReport, RelationshipInUseWithCorrectRelationshipTypeReport {
        @Override
    ...
    class NoConsistencyReport implements Reporter {
        ...
        NoConsistencyReport() {
            ...
            this.proxy = Proxy.newProxyInstance(
                    NoConsistencyReport.class.getClassLoader(), reports.toArray(new Class[0]), noop);
        }
