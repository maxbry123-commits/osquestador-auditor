...
public record DatabaseLogIdentifier(
        String prefix, String databaseName, String databaseId, Optional<String> externalId) {
    ...
    public static DatabaseLogIdentifier create(NamedDatabaseId namedDatabaseId) {
        return create(namedDatabaseId, Optional.empty());
    }

    @SuppressWarnings("OptionalUsedAsFieldOrParameterType")
    public static DatabaseLogIdentifier create(NamedDatabaseId namedDatabaseId, Optional<String> externalId) {
        requireNonNull(namedDatabaseId, "database id must be present");
        return new DatabaseLogIdentifier(
                "[%s] ".formatted(namedDatabaseId.logPrefix()),
