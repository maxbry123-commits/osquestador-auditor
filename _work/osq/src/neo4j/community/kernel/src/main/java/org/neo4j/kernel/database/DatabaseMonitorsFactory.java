...
public abstract class DatabaseMonitorsFactory {
    ...
    protected DatabaseMonitorsFactory(DatabaseMonitors databaseMonitors, boolean addToLife) {
        this.databaseMonitors = databaseMonitors;
        this.addToLife = addToLife;
    }

    public DatabaseMonitors create(LifeSupport life) {
        if (addToLife) {
