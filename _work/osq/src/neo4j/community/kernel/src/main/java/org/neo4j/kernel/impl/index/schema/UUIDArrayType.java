...
class UUIDArrayType extends AbstractArrayType<UUID> {
    UUIDArrayType(byte typeId) {
        super(
                ValueGroup.UUID_ARRAY,
                typeId,
                (o1, o2, i) -> UUIDType.compare(o1.long0Array[i], o1.long1Array[i], o2.long0Array[i], o2.long1Array[i]),
                (k, i) -> UUIDType.asValueRaw(k.long0Array[i], k.long1Array[i]),
                (c, k, i) -> UUIDType.put(c, k.long0Array[i], k.long1Array[i]),
                UUIDType::read,
                UUID[]::new,
                ValueWriter.ArrayType.UUID);
    }
    ...
    int valueSize(GenericKey<?> state) {
        return arrayKeySize(state, Types.SIZE_UUID);
    }
    ...
    public static void write(GenericKey<?> state, int offset, long msb, long lsb) {
        state.long0Array[offset] = msb;
        state.long1Array[offset] = lsb;
    }
}
