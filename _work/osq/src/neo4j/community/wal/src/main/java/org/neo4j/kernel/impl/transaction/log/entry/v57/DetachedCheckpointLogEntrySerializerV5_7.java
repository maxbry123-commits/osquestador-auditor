 ...
 *     </tr>
 *     <tr>
 *         <td>id(8) + checksum(4) + timestamp(8) + consensusIdx(8) = 28</td>
 ...
 *     </tr>
 *     <tr>
 *         <td>{@link #MAX_DESCRIPTION_LENGTH} = 108</td>
 *         <td>{@link String}</td>
 *         <td>reason</td>
 *     </tr>
 *     <tr>
...
public class DetachedCheckpointLogEntrySerializerV5_7 extends LogEntrySerializer<LogEntryDetachedCheckpointV5_0> {
    ...
    public LogEntryDetachedCheckpointV5_0 parse(
        ...
        var transactionId =
                new TransactionId(txId, txId, version, channel.getInt(), channel.getLong(), channel.getLong());
