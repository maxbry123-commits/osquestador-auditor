...
public class DetachedCheckpointLogEntrySerializerV5_20 extends LogEntrySerializer<LogEntryDetachedCheckpointV5_20> {
    ...
    @Override
    public LogEntryDetachedCheckpointV5_20 parse(
