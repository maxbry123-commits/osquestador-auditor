...
#define MBEDTLS_OID_UID                                                                            \
    "\x09\x92\x26\x89\x93\xF2\x2C\x64\x01\x01" /** id-domainComponent AttributeType:= {itu-t(0)    \
                                                  data(9) pss(2342) ucl(19200300) pilot(100)       \
                                                  pilotAttributeType(1) uid(1)} */
...
#define MBEDTLS_OID_DIGEST_ALG_RIPEMD160                                                           \
    ...
    "\x03\x02\x01" /**< id-ripemd160 OBJECT IDENTIFIER :: { iso(1) identified-organization(3)      \
                      teletrust(36) algorithm(3) hashAlgorithm(2) ripemd160(1) } */
