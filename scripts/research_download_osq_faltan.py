...
REPOS=[('01','docmost','https://github.com/docmost/docmost.git'),('02','wisemapping','https://github.com/wise-team/wisemapping.git'),('03','playwright','https://github.com/microsoft/playwright.git'),('04','ytmusicapi','https://github.com/sigma67/ytmusicapi.git'),('05','bm25s','https://github.com/xhluca/bm25s.git'),('06','sqlite-vec','https://github.com/asg017/sqlite-vec.git'),('07','qdrant','https://github.com/qdrant/qdrant.git'),('08','lancedb','https://github.com/lancedb/lancedb.git'),('09','chroma','https://github.com/chroma-core/chroma.git'),('10','SWE-agent','https://github.com/princeton-nlp/SWE-agent.git'),('11','asyncpg','https://github.com/MagicStack/asyncpg.git'),('12','aiomysql','https://github.com/aio-libs/aiomysql.git'),('13','Chart.js','https://github.com/chartjs/Chart.js.git'),('14','cryptography','https://github.com/pyca/cryptography.git'),('15','deep-research','https://github.com/dzhng/deep-research.git'),('16','agents-deep-research','https://github.com/qx-labs/agents-deep-research.git'),('17','docker-py','https://github.com/docker/docker-py.git'),('18','guardrails','https://github.com/guardrails-ai/guardrails.git'),('19','plex','https://github.com/IBM/plex.git'),('20','llama_index','https://github.com/run-llama/llama_index.git'),('21','lucide','https://github.com/lucide-icons/lucide.git'),('22','python-sdk','https://github.com/modelcontextprotocol/python-sdk.git'),('23','servers','https://github.com/modelcontextprotocol/servers.git'),('24','n8n','https://github.com/n8n-io/n8n.git'),('25','ollama','https://github.com/ollama/ollama.git'),('26','phoenix','https://github.com/Arize-ai/phoenix.git'),('27','pydantic','https://github.com/pydantic/pydantic.git'),('28','pydantic-settings','https://github.com/pydantic/pydantic-settings.git'),('29','pydantic-ai','https://github.com/pydantic/pydantic-ai.git'),('30','pyyaml','https://github.com/yaml/pyyaml.git'),('31','react','https://github.com/facebook/react.git'),('32','redis-py','https://github.com/redis/redis-py.git'),('33','starlette','https://github.com/encode/starlette.git'),('34','tailwindcss','https://github.com/tailwindlabs/tailwindcss.git'),('35','vllm','https://github.com/vllm-project/vllm.git'),('36','zustand','https://github.com/pmndrs/zustand.git')]
...
print('===== QUEUE COMPLETE: osq faltan processed =====')
