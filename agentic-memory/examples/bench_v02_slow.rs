...
use agentic_memory::{
    AnalogicalAnchor, AnalogicalParams, ConsolidationOp, ConsolidationParams,
    DriftParams, GapDetectionParams, GapSeverity,
};
...
fn main() {
    ...
    for &n in &[10_000usize, 100_000] {
        ...
        let params = GapDetectionParams {
            confidence_threshold: 0.5, min_support_count: 2, max_results: 50,
            session_range: None, sort_by: GapSeverity::HighestImpact,
        };
        ...
        let params = AnalogicalParams {
            ...
            context_depth: 2, max_results: 5, min_similarity: 0.0,
        ...
        let params = ConsolidationParams {
            ...
            dry_run: true, backup_path: None,
        };
        let r = qe.consolidate(&mut graph, params);
        let elapsed = start.elapsed();
        println!("consolidation_dryrun_{}: {:?} (ok={})", n, elapsed, r.is_ok());
